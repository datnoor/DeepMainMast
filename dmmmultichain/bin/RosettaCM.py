...
def get_args(): 
    ...
    parser.add_argument('--XMLPath', type=str, dest='XMLPath', default='/net/kihara/home/gterashi/DeepMainmast/BenchMark_Mainmast_Unet_complex_af2/bin/', help='Copy *.xml and *.sh files')
